...
type Command = "serve" | "init" | "doctor" | "config" | "maintenance" | "agents" | "help" | "version";
...
function normalizeCommand(command: string | undefined): Command {
  ...
  if (command === "init" || command === "doctor" || command === "config" || command === "maintenance" || command === "agents") return command;
